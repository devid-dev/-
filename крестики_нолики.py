...
while running:
    ...
    class x():
        def draw_x(move):
                if places_x[0] == 1 and move == 1 :
                    screen.blit(x_img , (0 , 0))
                    move=2
                if places_x[1] == 2 and move == 1:
                    screen.blit(x_img , (210 , 0))
                    move=2
                if places_x[2] == 3 and move == 1:
                    screen.blit(x_img , (420 , 0))
                    move=2
                if places_x[3] == 4 and move == 1:
                    screen.blit(x_img , (0 , 210))
                    move=2
                if places_x[4] == 5 and move == 1:
                    screen.blit(x_img , (210 , 210))
                    move=2
                if places_x[5] == 6 and move == 1:
    ...
    class o():
            def move_o(move):
                if places_x[0] == 1 and move == 2:
                    places_o[8]=9
                if places_x[2] == 3 and move == 2:
                    places_o[6]=7
                if places_x[6] == 7 and move == 2:
                    places_x[2]=3
                if places_x[8] == 9 and move == 2:
                    places_o[0]=1
                else:
                    if places_x[1] == 2 or places_x[3] == 4 or places_x[5] == 6 or places_x[7] == 8 and x.move == 2:
                        places_o[4]=5
                if places_x[0] == 1 and places_x[1] == 2 and move == 2:
                    places_o[2]=3
                if places_x[0] == 1 and places_x[2] == 3 and move == 2:
                    places_o[1]=2
                if places_x[1] == 2 and places_x[2] == 3 and move == 2:
                    places_o[0]=1
                if places_x[3] == 4 and places_x[4] == 5 and move == 2:
                    places_o[5]=6
                if places_x[3] == 4 and places_x[5] == 6 and move == 2:
                    places_o[4]=5
                if places_x[4] == 5 and places_x[5] == 6 and move == 2:
                    places_o[3]=4
                if places_x[6] == 7 and places_x[7] == 8 and move == 2:
                    places_o[8]=9
                if places_x[6] == 7 and places_x[8] == 9 and move == 2:
                    places_o[7]=8
                if places_x[7] == 8 and places_x[8] == 9 and move == 2:
                    places_o[6]=7
                if places_x[0] == 1 and places_x[3] == 4 and move == 2:
                    places_o[6]=7
                if places_x[0] == 1 and places_x[6] == 7 and move == 2:
                    places_o[3]=4
                if places_x[3] == 4 and places_x[6] == 7 and move == 2:
                    places_o[0]=1
                if places_x[1] == 2 and places_x[4] == 5 and move == 2:
                    places_o[7]=8
                if places_x[1] == 2 and places_x[7] == 8 and move == 2:
                    places_o[4]=5
                if places_x[4] == 5 and places_x[7] == 8 and move == 2:
                    places_o[1]=2
                if places_x[0] == 1 and places_x[4] == 5 and move == 2:
                    places_o[8]=9
                if places_x[0] == 1 and places_x[8] == 9 and move == 2:
                    places_o[4]=5
                if places_x[4] == 5 and places_x[8] == 9 and move == 2:
                    places_o[0]=1
                if places_x[2] == 3 and places_x[4] == 5 and move == 2:
                    places_o[6]=7
                if places_x[2] == 3 and places_x[6] == 7 and move == 2:
                    places_o[4]=5
                if places_x[4] == 5 and places_x[6] == 7 and move == 2:
                    places_o[2]=3
                else:
                    if places_o[8] == 9 and places_x[7] == 0 and move == 2:
                        places_o[7]=8
                    if places_o[8] == 9 and places_o[7] == 8 and places_x[6] == o and move == 2:
                        places_o[6]=7
                    else:
                        if places_o[8] == 9 and places_x[5] == 0 and move == 2:
                            places_o[5]=6
                        if places_o[8] == 9 and places_o[5] == 6 and places_x[2] == 0 and move == 2:
                            places_o[2]=3
            def draw_o(move):
                if places_o[0] == 1 :
