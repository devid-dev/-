...
def end():
    #конец игры
    if places_o[0] == 1 and places_o[1] == 2 and places_o[2] == 3:
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[0] == 1 and places_x[1] == 2 and places_x[2] == 3:
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[3] == 4 and places_o[4] == 5 and places_o[5] == 6:
        top_left=(100 , 310)
        top_right=(520 , 310)
        bottom_right=(520 , 320)
        bottom_left=(100 , 320)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[3] == 4 and places_x[4] == 5 and places_x[5] == 6:
        top_left=(100 , 310)
        top_right=(520 , 310)
        bottom_right=(520 , 320)
        bottom_left=(100 , 320)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[6] == 7 and places_o[7] == 8 and places_o[8] == 9:
        top_left=(100 , 520)
        top_right=(520 , 520)
        bottom_right=(520 , 530)
        bottom_left=(100 , 530)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[6] == 7 and places_x[7] == 8 and places_x[8] == 9:
        top_left=(100 , 520)
        top_right=(520 , 520)
        bottom_right=(520 , 530)
        bottom_left=(100 , 530)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[0] == 1 and places_o[3] == 4 and places_o[6] == 7:
        top_left=(100 , 100)
        top_right=(110 , 100)
        bottom_right=(110 , 520)
        bottom_left=(100 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[0] == 1 and places_x[3] == 4 and places_x[6] == 7:
        top_left=(100 , 100)
        top_right=(110 , 100)
        bottom_right=(110 , 520)
        bottom_left=(100 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[1] == 2 and places_x[4] == 5 and places_x[7] == 8:
        top_left=(310 , 100)
        top_right=(320 , 100)
        bottom_right=(320 , 520)
        bottom_left=(310 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[1] == 2 and places_o[4] == 5 and places_o[7] == 8:
        top_left=(310 , 100)
        top_right=(320 , 100)
        bottom_right=(320 , 520)
        bottom_left=(310 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[2] == 3 and places_x[5] == 6 and places_x[8] == 9:
        top_left=(520 , 100)
        top_right=(530 , 100)
        bottom_right=(530 , 520)
        bottom_left=(520 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[2] == 3 and places_o[5] == 6 and places_o[8] == 9:
        top_left=(520 , 100)
        top_right=(530 , 100)
        bottom_right=(530 , 520)
        bottom_left=(520 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[0] == 1 and places_x[4] == 5 and places_x[8] == 9:
        top_left=(100 , 110)
        top_right=(110 , 100)
        bottom_right=(530 , 520)
        bottom_left=(520 , 530)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[0] == 1 and places_o[4] == 5 and places_o[8] == 9:
        top_left=(100 , 110)
        top_right=(110 , 100)
        bottom_right=(530 , 520)
        bottom_left=(520 , 530)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_x[2] == 3 and places_x[4] == 5 and places_x[6] == 7:
        top_left=(520 , 100)
        top_right=(530 , 110)
        bottom_right=(110 , 530)
        bottom_left=(100 , 520)
        pygame.draw.polygon(screen , (255 , 0 , 0) , vertices , 0)
    if places_o[2] == 3 and places_o[4] == 5 and places_o[6] == 7:
        top_left=(520 , 100)
        top_right=(530 , 110)
        bottom_right=(110 , 530)
        bottom_left=(100 , 520)
